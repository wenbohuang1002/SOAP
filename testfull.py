...
import video_reader as video_reader
...
class Learner:
    ...
    def parse_command_line(self):
        ...
        parser.add_argument("--best_model_path", default='best_model/kinetics/1-shot/checkpoint_best_val.pt', help="The best model path")
    ...
    def evaluate(self, mode="val"):
        ...
        with torch.no_grad():
            ...
            for task_dict in tqdm(self.video_loader, ncols=100, total=self.args.num_test_tasks, colour='green'):
